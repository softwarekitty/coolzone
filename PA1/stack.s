...
str_const0:
	...
	.word	String_dispTab
	.word	int_const14
	.ascii	"we never print the dummy element"
	.byte	0	
	.align	2
	.word	-1
int_const14:
...
class_objTab:
	...
	.word	String_protObj
	.word	String_init
	.word	CustomStack_protObj
	.word	CustomStack_init
	.word	A2I_protObj
	.word	A2I_init
Object_dispTab:
	.word	Object.abort
...
CustomStack_dispTab:
	...
	.word	Object.type_name
	.word	Object.copy
	.word	CustomStack.init
	.word	CustomStack.push
	.word	CustomStack.display
	.word	CustomStack.evaluate
String_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
...
El_dispTab:
	...
	.word	El.setNext
	.word	El.getVal
	.word	El.isDummyElement
	.word	El.printElement
IntEl_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
...
Main.main:
	...
	la	$a0 str_const5
	sw	$a0 12($s0)
	la	$a0 CustomStack_protObj
	jal	Object.copy
	jal	CustomStack_init
